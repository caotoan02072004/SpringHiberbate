...
alter table accounts alter column username nvarchar(200)
Update accounts SET username = 'user1' Where id = 7
...
insert into Employee values(N'Nguyễn Văn M', '1','2000-12-12', N'Hà Nội', '0963258741', N'Quản lý', 30000000, 1,3,1,1)

Update Employee set Birthday = '2001-11-10'
