		...
		<div class="row">
			<div class="col-md-12">
				<div class="main-card mb-3 card">
					<div class="card-body">
						<form method="post"
							action="${pageContext.request.contextPath}/admin/certificate/update" enctype="multipart/form-data">
							...
							<div class="position-relative row form-group">
								...
								<div class="col-md-9 col-xl-8">
									<img style="height: 200px;width: 200px; cursor: pointer;"
										...
										src="${pageContext.request.contextPath}/resources/${certificate.image}" alt="Avatar">
							...
							<div class="position-relative row form-group">
								...
								<div class="col-md-9 col-xl-8">
									<input name="name" placeholder="Name" type="text"
										class="form-control" value="${certificate.name}">
								</div>
							</div>
							...
							<div class="position-relative row form-group">
								...
								<div class="col-md-9 col-xl-8">
									<input name="address" placeholder="Address" type="text"
										class="form-control" value="${certificate.address}">
								</div>
							</div>
							<div class="position-relative row form-group">
								<label for="name" class="col-md-3 text-md-right col-form-label">Expiration
									Date</label>
								<div class="col-md-9 col-xl-8">
									<input name="expiration_date" placeholder="Expiration Date"
								...
								<div class="form-group" style="margin: 8px 15px;">
									...
									<div class="form-check form-check-inline">
										<label class="form-check-label"> <input
											...
											${certificate.status == 0 ? "checked" : ""}> Ẩn
										</label>
									</div>
								</div>
							</div>
