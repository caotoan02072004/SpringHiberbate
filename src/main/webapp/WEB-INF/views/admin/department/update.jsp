		...
		<div class="row">
			<div class="col-md-12">
				<div class="main-card mb-3 card">
					<div class="card-body">
						<form method="post" action="${pageContext.request.contextPath}/admin/department/update">
								...
								<div class="form-group" style="margin: 8px 15px;">
									<div class="form-check form-check-inline">
										<label class="form-check-label"> <input
											...
											value="1" ${department.status == 1 ? "checked" : "" }> Show
										</label>
									</div>
									<div class="form-check form-check-inline">
										<label class="form-check-label"> <input
											class="form-check-input" type="radio" name="status" value="0" ${department.status == 0 ? "checked" : ""}>Hide
										</label>
									</div>
								</div>
							</div>
