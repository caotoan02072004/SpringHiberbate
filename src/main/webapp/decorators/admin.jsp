...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources//my_style.css" rel="stylesheet">
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div >
                    <img src="https://logos.textgiraffe.com/logos/logo-name/Admin-designstyle-pastel-m.png" alt="anh" width="150px" class="ml-4">
                </div>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                <a href="#">
                                    <i style="font-size: 20px !important;font-weight:bold;" class="fa-solid fa-house metismenu-icon" ></i>Applications
                                    <i style="font-size: 20px !important;" class="fa-solid fa-chevron-down pe-7s-angle-down metismenu-state-icon caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <a href="${pageContext.request.contextPath}/admin/certificate">
                                            <i class="metismenu-icon"></i>Certificate
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="${pageContext.request.contextPath}/admin/employee">
                                            <i class="metismenu-icon"></i>Employee
                                        </a>
                                    </li>
                                </ul>
                            </li>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/scripts/my_script.js"></script>
</body>
